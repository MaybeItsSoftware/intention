...
// The claim is sealed in the token and echoed in the response body, so the
// client stores the same value the token carries.
...
// USER DECISION D3. Without it a device that recovered its account holds a token
